...
<body>
	...
	<div class="w3-container w3-margin w3-border entete_style">
		<h3 class="w3-opacity bold_style w3-text-white">ENREGISTREMENT DES EDUCATEURS</h3>
	</div>
	<div class="w3-container">
		<form method="POST" action="./sauvegarde_educ.php" enctype="multipart/form-data" class="w3-container">
	...
	<div class="w3-container w3-margin w3-border entete_style">
	<h3 class="w3-opacity bold_style w3-text-white">LISTE DES EDUCATEURS</h3>
	</div>
	...
	<table class="w3-table-all w3-hoverable">
		...
		<?php while ($etudiant=$ps->fetch()) { ?>
            ...
            <tr>
				...
				<td class="w3-center"><a href="profil_educateur.php?id=<?php echo($etudiant['ID'])?>"><i class="fa fa-eye w3-xlarge"></i></a></td>
				<td class="w3-center"><a href="message.php?id=<?php echo ($etudiant['ID'])?>"><i class="fa fa-comment w3-xlarge"></i></a></td>
				
				<?php if ($_SESSION['PROFILE']['ROLE']=='admin'){ ?>
				<td class="w3-center"><a href="modification_educ.php?id=<?php echo($etudiant['ID'])?>"><i class="fa fa-edit w3-xlarge"></i></a></td>
				<td class="w3-center"><a onclick="return confirm('Etes-vous sûr de supprimer ce profil');"	href="supprimer_educ.php?id=<?php echo($etudiant['ID'])?>"><i class="fa fa-trash w3-xlarge"></i></a></td>
				<?php } ?>
			</tr>
		<?php } } ?>
		</tbody>
