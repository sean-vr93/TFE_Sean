...
$ps70=$pdo->prepare("SELECT * FROM educateurs WHERE ID=?");
$params70=array($id);
...
<body>
	...
	<div class="w3-container w3-margin w3-border entete_style">
		<h3 class="w3-opacity bold_style w3-text-white">EDITION DES EDUCATEURS</h3>
	</div>
	<div class="w3-container">
		<form method="POST" action="./update_educateur.php" enctype="multipart/form-data" class="w3-container">
